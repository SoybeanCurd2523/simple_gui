...
MainWindow::MainWindow(int argc, char** argv, QWidget *parent)
	...
	, qnode(argc,argv)
{
  ROS_INFO("MainWindow constructor");
  ...
  //dialog->show();//add
    ...
    QObject::connect(&qnode, SIGNAL(rosShutdown()), this, SLOT(close())); // quit_botton
  ...
  //ui.view_logging->setModel(qnode.loggingModel());
    ...
    **********************/
    ...
    QObject::connect(&qnode, SIGNAL(statusUpdated()), this, SLOT(updateState())); // this use
...
//    QObject::connect(ui.pushButton_1, SIGNAL(clicked()), this, SLOT(Forward()));
...
*/
   ...
   kookmin_img.load(":/images/Signature_KMU4.jpg");

   cat1_img.load(":/images/cat1.jpg");
   cat2_img.load(":/images/cat2.jpg");

   ui.label_7->setPixmap(kookmin_img);
...
//  system(c_html); // as same as terminal input
...
void simple_gui::MainWindow::on_quit_button_clicked()
{
        ROS_INFO(" SHUTDOWN ");
        is_shutdown = true;
//      rov_command = 0;
...
//      ros::shutdown(); //? special number for shutdown? -1 ?
      // camera_is_running delete??
}


///////////  ROV  /////////////
void simple_gui::MainWindow::on_pushButton_1_clicked()
{
       rov_command =1;
       ROS_INFO("ROV_forward");
}

void simple_gui::MainWindow::on_pushButton_2_clicked()
{
      rov_command = 2;
      ROS_INFO("ROV_left");
}

void simple_gui::MainWindow::on_pushButton_3_clicked()
{
      rov_command =3;
      ROS_INFO("ROV_right");
}

void simple_gui::MainWindow::on_pushButton_4_clicked()
{
      rov_command =4;
      ROS_INFO("ROV_backward");
}

void simple_gui::MainWindow::on_pushButton_5_clicked()
{
      rov_command =5;
      ROS_INFO("ROV_turnleft");
}

void simple_gui::MainWindow::on_pushButton_6_clicked()
{
      rov_command =6;
      ROS_INFO("ROV_turnright");
}

void simple_gui::MainWindow::on_pushButton_7_clicked()
{
      rov_command =7;
      ROS_INFO("ROV_up");
}

void simple_gui::MainWindow::on_pushButton_8_clicked()
{
      rov_command =8;
      ROS_INFO("ROV_down");
}
...
void simple_gui::MainWindow::on_pushButton_9_clicked()
{
      led_command = 1;
      ROS_INFO("LED_on");
}

void simple_gui::MainWindow::on_pushButton_10_clicked()
{
      led_command = 2;
      ROS_INFO("LED_Off");
}
...
/// void simple_gui::MainWindow::on_pushButton_11_clicked()
/// {
///       camera_command = 1;
///       ROS_INFO("CAMERA_left");
/// }
///
/// void simple_gui::MainWindow::on_pushButton_12_clicked()
/// {
///       camera_command = 2;
///       ROS_INFO("CAMERA_right");
/// }
///
/// void simple_gui::MainWindow::on_pushButton_13_clicked()
/// {
///       camera_command = 3;
///       ROS_INFO("CAMERA_up");
/// }
///
/// void simple_gui::MainWindow::on_pushButton_14_clicked()
/// {
///       camera_command = 4;
///       ROS_INFO("CAMERA_down");
/// }
///


void simple_gui::MainWindow::on_pushButton_clicked() // stop. rov고정, camera 고정, led키고
{
    rov_command = 0;
    camera_command = 0;
    led_command = 1;
...
void simple_gui::MainWindow::on_pushButton_11_pressed()
{
  camera_command = 1;
  ROS_INFO("CAMERA_left");
}

void simple_gui::MainWindow::on_pushButton_11_released()
{
  camera_command = 0;
}

void simple_gui::MainWindow::on_pushButton_12_pressed()
{
  camera_command = 2;
  ROS_INFO("CAMERA_right");
}

void simple_gui::MainWindow::on_pushButton_12_released()
{
    camera_command = 0;
}

void simple_gui::MainWindow::on_pushButton_13_pressed()
{
  camera_command = 3;
  ROS_INFO("CAMERA_up");
}

void simple_gui::MainWindow::on_pushButton_13_released()
{
    camera_command = 0;
}

void simple_gui::MainWindow::on_pushButton_14_pressed()
{
  camera_command = 4;
  ROS_INFO("CAMERA_down");
}

void simple_gui::MainWindow::on_pushButton_14_released()
{
  camera_command = 0;
}

void simple_gui::MainWindow::on_pushButton_15_clicked()
{
  camera_command = 5;
}
